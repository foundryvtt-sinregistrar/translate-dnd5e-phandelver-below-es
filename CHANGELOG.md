...
- Empty translation templates for adventures, actors, items, player options, and roll tables.
...
- Spanish translation of the Charlatan, Criminal, Folk Hero, Entertainer, Guild Artisan, Hermit, Noble, Outlander, Sage, and Sailor background tables.
